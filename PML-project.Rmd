...
This seems to confirm our original estimates. The 95% confidence interval for accuracy is between `r lower.acc` and `r upper.acc`. This corresponds to an error rate of `r acc` with an interval of `r 1- lower.acc` to `r 1 - upper.acc`.
